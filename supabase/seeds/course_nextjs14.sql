...
DELETE FROM quiz_questions WHERE quiz_id IN (
  SELECT id FROM quizzes WHERE lesson_id IN (
    SELECT id FROM lessons WHERE course_id = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
  )
);
...
DELETE FROM lessons WHERE course_id = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890';
...
('11111111-0001-0001-0001-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '11111111-1111-1111-1111-111111111111',
 '¿Por qué Next.js? El problema que resuelve',
 'Ver archivo: content/courses/nextjs-14/module-01/lesson-01.md',
 'text', 1, true, NOW()),

('11111111-0001-0001-0001-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '11111111-1111-1111-1111-111111111111',
 'Arquitectura del App Router',
 'Ver archivo: content/courses/nextjs-14/module-01/lesson-02.md',
 'text', 2, true, NOW()),

('11111111-0001-0001-0001-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '11111111-1111-1111-1111-111111111111',
 'Setup del entorno de desarrollo',
 'Ver archivo: content/courses/nextjs-14/module-01/lesson-03.md',
 'video', 3, true, NOW()),

('11111111-0001-0001-0001-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '11111111-1111-1111-1111-111111111111',
 'Tu primera página',
 'Ver archivo: content/courses/nextjs-14/module-01/lesson-04.md',
 'text', 4, true, NOW()),

('11111111-0001-0001-0001-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '11111111-1111-1111-1111-111111111111',
...
INSERT INTO lessons (id, course_id, module_id, title, content, lesson_type, order_index, is_required, created_at) VALUES
('22222222-0002-0002-0002-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '22222222-2222-2222-2222-222222222222',
 'Rutas estáticas y dinámicas',
 'Ver archivo: content/courses/nextjs-14/module-02/lesson-01.md',
 'text', 1, true, NOW()),

('22222222-0002-0002-0002-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '22222222-2222-2222-2222-222222222222',
 'Layouts anidados y templates',
 'Ver archivo: content/courses/nextjs-14/module-02/lesson-02.md',
 'text', 2, true, NOW()),

('22222222-0002-0002-0002-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '22222222-2222-2222-2222-222222222222',
 'Loading, Error y Not Found',
 'Ver archivo: content/courses/nextjs-14/module-02/lesson-03.md',
 'text', 3, true, NOW()),

('22222222-0002-0002-0002-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '22222222-2222-2222-2222-222222222222',
 'Parallel Routes e Intercepting Routes',
 'Ver archivo: content/courses/nextjs-14/module-02/lesson-04.md',
 'text', 4, true, NOW()),

('22222222-0002-0002-0002-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '22222222-2222-2222-2222-222222222222',
 'Navegación y Link component',
 'Ver archivo: content/courses/nextjs-14/module-02/lesson-05.md',
 'video', 5, true, NOW()),

('22222222-0002-0002-0002-000000000006', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '22222222-2222-2222-2222-222222222222',
...
INSERT INTO lessons (id, course_id, module_id, title, content, lesson_type, order_index, is_required, created_at) VALUES
('33333333-0003-0003-0003-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '33333333-3333-3333-3333-333333333333',
 'Server vs Client Components',
 'Ver archivo: content/courses/nextjs-14/module-03/lesson-01.md',
 'text', 1, true, NOW()),

('33333333-0003-0003-0003-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '33333333-3333-3333-3333-333333333333',
 'Fetching en Server Components',
 'Ver archivo: content/courses/nextjs-14/module-03/lesson-02.md',
 'text', 2, true, NOW()),

('33333333-0003-0003-0003-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '33333333-3333-3333-3333-333333333333',
 'Caching y Revalidación',
 'Ver archivo: content/courses/nextjs-14/module-03/lesson-03.md',
 'text', 3, true, NOW()),

('33333333-0003-0003-0003-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '33333333-3333-3333-3333-333333333333',
 'Patrones de composición',
 'Ver archivo: content/courses/nextjs-14/module-03/lesson-04.md',
 'text', 4, true, NOW()),

('33333333-0003-0003-0003-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '33333333-3333-3333-3333-333333333333',
 'Streaming y Suspense',
 'Ver archivo: content/courses/nextjs-14/module-03/lesson-05.md',
 'video', 5, true, NOW()),

('33333333-0003-0003-0003-000000000006', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '33333333-3333-3333-3333-333333333333',
...
INSERT INTO lessons (id, course_id, module_id, title, content, lesson_type, order_index, is_required, created_at) VALUES
('44444444-0004-0004-0004-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '44444444-4444-4444-4444-444444444444',
 'Introducción a Server Actions',
 'Ver archivo: content/courses/nextjs-14/module-04/lesson-01.md',
 'text', 1, true, NOW()),

('44444444-0004-0004-0004-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '44444444-4444-4444-4444-444444444444',
 'Validación y manejo de errores',
 'Ver archivo: content/courses/nextjs-14/module-04/lesson-02.md',
 'text', 2, true, NOW()),

('44444444-0004-0004-0004-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '44444444-4444-4444-4444-444444444444',
 'Optimistic Updates',
 'Ver archivo: content/courses/nextjs-14/module-04/lesson-03.md',
 'text', 3, true, NOW()),

('44444444-0004-0004-0004-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '44444444-4444-4444-4444-444444444444',
 'Revalidación después de mutaciones',
 'Ver archivo: content/courses/nextjs-14/module-04/lesson-04.md',
 'text', 4, true, NOW()),

('44444444-0004-0004-0004-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '44444444-4444-4444-4444-444444444444',
...
INSERT INTO lessons (id, course_id, module_id, title, content, lesson_type, order_index, is_required, created_at) VALUES
('55555555-0005-0005-0005-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '55555555-5555-5555-5555-555555555555',
 'Estrategias de autenticación',
 'Ver archivo: content/courses/nextjs-14/module-05/lesson-01.md',
 'text', 1, true, NOW()),

('55555555-0005-0005-0005-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '55555555-5555-5555-5555-555555555555',
 'Implementación con NextAuth.js / Auth.js',
 'Ver archivo: content/courses/nextjs-14/module-05/lesson-02.md',
 'video', 2, true, NOW()),

('55555555-0005-0005-0005-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '55555555-5555-5555-5555-555555555555',
 'Middleware para protección de rutas',
 'Ver archivo: content/courses/nextjs-14/module-05/lesson-03.md',
 'text', 3, true, NOW()),

('55555555-0005-0005-0005-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '55555555-5555-5555-5555-555555555555',
 'Roles y permisos',
 'Ver archivo: content/courses/nextjs-14/module-05/lesson-04.md',
 'text', 4, true, NOW()),

('55555555-0005-0005-0005-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '55555555-5555-5555-5555-555555555555',
...
INSERT INTO lessons (id, course_id, module_id, title, content, lesson_type, order_index, is_required, created_at) VALUES
('66666666-0006-0006-0006-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '66666666-6666-6666-6666-666666666666',
 'Opciones de base de datos',
 'Ver archivo: content/courses/nextjs-14/module-06/lesson-01.md',
 'text', 1, true, NOW()),

('66666666-0006-0006-0006-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '66666666-6666-6666-6666-666666666666',
 'Prisma vs Drizzle',
 'Ver archivo: content/courses/nextjs-14/module-06/lesson-02.md',
 'text', 2, true, NOW()),

('66666666-0006-0006-0006-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '66666666-6666-6666-6666-666666666666',
 'Queries en Server Components',
 'Ver archivo: content/courses/nextjs-14/module-06/lesson-03.md',
 'text', 3, true, NOW()),

('66666666-0006-0006-0006-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '66666666-6666-6666-6666-666666666666',
 'Transacciones y manejo de errores',
 'Ver archivo: content/courses/nextjs-14/module-06/lesson-04.md',
 'text', 4, true, NOW()),

('66666666-0006-0006-0006-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '66666666-6666-6666-6666-666666666666',
...
INSERT INTO lessons (id, course_id, module_id, title, content, lesson_type, order_index, is_required, created_at) VALUES
('77777777-0007-0007-0007-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '77777777-7777-7777-7777-777777777777',
 'CSS Modules vs Tailwind',
 'Ver archivo: content/courses/nextjs-14/module-07/lesson-01.md',
 'text', 1, true, NOW()),

('77777777-0007-0007-0007-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '77777777-7777-7777-7777-777777777777',
 'Componentes UI: shadcn/ui',
 'Ver archivo: content/courses/nextjs-14/module-07/lesson-02.md',
 'video', 2, true, NOW()),

('77777777-0007-0007-0007-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '77777777-7777-7777-7777-777777777777',
 'Fonts y optimización de assets',
 'Ver archivo: content/courses/nextjs-14/module-07/lesson-03.md',
 'text', 3, true, NOW()),

('77777777-0007-0007-0007-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '77777777-7777-7777-7777-777777777777',
 'Animaciones con Framer Motion',
 'Ver archivo: content/courses/nextjs-14/module-07/lesson-04.md',
 'text', 4, true, NOW()),

('77777777-0007-0007-0007-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '77777777-7777-7777-7777-777777777777',
...
INSERT INTO lessons (id, course_id, module_id, title, content, lesson_type, order_index, is_required, created_at) VALUES
('88888888-0008-0008-0008-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '88888888-8888-8888-8888-888888888888',
 'Testing de componentes con Vitest',
 'Ver archivo: content/courses/nextjs-14/module-08/lesson-01.md',
 'text', 1, true, NOW()),

('88888888-0008-0008-0008-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '88888888-8888-8888-8888-888888888888',
 'Testing de Server Actions',
 'Ver archivo: content/courses/nextjs-14/module-08/lesson-02.md',
 'text', 2, true, NOW()),

('88888888-0008-0008-0008-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '88888888-8888-8888-8888-888888888888',
 'E2E con Playwright',
 'Ver archivo: content/courses/nextjs-14/module-08/lesson-03.md',
 'video', 3, true, NOW()),

('88888888-0008-0008-0008-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '88888888-8888-8888-8888-888888888888',
...
INSERT INTO lessons (id, course_id, module_id, title, content, lesson_type, order_index, is_required, created_at) VALUES
('99999999-0009-0009-0009-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '99999999-9999-9999-9999-999999999999',
 'Core Web Vitals en Next.js',
 'Ver archivo: content/courses/nextjs-14/module-09/lesson-01.md',
 'text', 1, true, NOW()),

('99999999-0009-0009-0009-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '99999999-9999-9999-9999-999999999999',
 'Bundle analysis y code splitting',
 'Ver archivo: content/courses/nextjs-14/module-09/lesson-02.md',
 'text', 2, true, NOW()),

('99999999-0009-0009-0009-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '99999999-9999-9999-9999-999999999999',
 'Edge Runtime vs Node.js',
 'Ver archivo: content/courses/nextjs-14/module-09/lesson-03.md',
 'text', 3, true, NOW()),

('99999999-0009-0009-0009-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '99999999-9999-9999-9999-999999999999',
 'ISR y generación estática',
 'Ver archivo: content/courses/nextjs-14/module-09/lesson-04.md',
 'text', 4, true, NOW()),

('99999999-0009-0009-0009-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '99999999-9999-9999-9999-999999999999',
...
INSERT INTO lessons (id, course_id, module_id, title, content, lesson_type, order_index, is_required, created_at) VALUES
('aaaaaaaa-000a-000a-000a-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
 'Deploy en Vercel',
 'Ver archivo: content/courses/nextjs-14/module-10/lesson-01.md',
 'video', 1, true, NOW()),

('aaaaaaaa-000a-000a-000a-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
 'Alternativas: Docker y self-hosted',
 'Ver archivo: content/courses/nextjs-14/module-10/lesson-02.md',
 'text', 2, true, NOW()),

('aaaaaaaa-000a-000a-000a-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
 'Monitoreo y observabilidad',
 'Ver archivo: content/courses/nextjs-14/module-10/lesson-03.md',
 'text', 3, true, NOW()),

('aaaaaaaa-000a-000a-000a-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
 'CI/CD pipeline',
 'Ver archivo: content/courses/nextjs-14/module-10/lesson-04.md',
 'text', 4, true, NOW()),

('aaaaaaaa-000a-000a-000a-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
...
VALUES (
  ...
  '99999999-0009-0009-0009-000000000005',
  'Quiz: Performance y Optimización',
...
('qe111-001', 'q1111111-1111-1111-1111-111111111111', 'mcq',
...
('qe111-002', 'q1111111-1111-1111-1111-111111111111', 'mcq',
...
('qe111-003', 'q1111111-1111-1111-1111-111111111111', 'true_false',
...
('qe111-004', 'q1111111-1111-1111-1111-111111111111', 'mcq',
...
('qe111-005', 'q1111111-1111-1111-1111-111111111111', 'mcq',
...
('qe111-006', 'q1111111-1111-1111-1111-111111111111', 'true_false',
...
('qe111-007', 'q1111111-1111-1111-1111-111111111111', 'mcq',
...
('qe111-008', 'q1111111-1111-1111-1111-111111111111', 'mcq',
...
('qe111-009', 'q1111111-1111-1111-1111-111111111111', 'true_false',
...
('qe111-010', 'q1111111-1111-1111-1111-111111111111', 'mcq',
...
INSERT INTO quiz_questions (id, quiz_id, question_type, question, options, points, order_index, explanation, created_at) VALUES
('qe222-001', 'q2222222-2222-2222-2222-222222222222', 'mcq',
...
('qe222-002', 'q2222222-2222-2222-2222-222222222222', 'mcq',
...
('qe222-003', 'q2222222-2222-2222-2222-222222222222', 'mcq',
...
('qe222-004', 'q2222222-2222-2222-2222-222222222222', 'true_false',
...
('qe222-005', 'q2222222-2222-2222-2222-222222222222', 'mcq',
...
('qe222-006', 'q2222222-2222-2222-2222-222222222222', 'mcq',
...
('qe222-007', 'q2222222-2222-2222-2222-222222222222', 'mcq',
...
('qe222-008', 'q2222222-2222-2222-2222-222222222222', 'mcq',
...
('qe222-009', 'q2222222-2222-2222-2222-222222222222', 'true_false',
...
('qe222-010', 'q2222222-2222-2222-2222-222222222222', 'mcq',
...
INSERT INTO quiz_questions (id, quiz_id, question_type, question, options, points, order_index, explanation, created_at) VALUES
('qe333-001', 'q3333333-3333-3333-3333-333333333333', 'mcq',
...
('qe333-002', 'q3333333-3333-3333-3333-333333333333', 'true_false',
...
('qe333-003', 'q3333333-3333-3333-3333-333333333333', 'mcq',
...
('qe333-004', 'q3333333-3333-3333-3333-333333333333', 'mcq',
...
('qe333-005', 'q3333333-3333-3333-3333-333333333333', 'mcq',
...
('qe333-006', 'q3333333-3333-3333-3333-333333333333', 'mcq',
...
('qe333-007', 'q3333333-3333-3333-3333-333333333333', 'true_false',
...
('qe333-008', 'q3333333-3333-3333-3333-333333333333', 'mcq',
...
('qe333-009', 'q3333333-3333-3333-3333-333333333333', 'mcq',
...
('qe333-010', 'q3333333-3333-3333-3333-333333333333', 'mcq',
...
INSERT INTO quiz_questions (id, quiz_id, question_type, question, options, points, order_index, explanation, created_at) VALUES
('qe555-001', 'q5555555-5555-5555-5555-555555555555', 'mcq',
...
('qe555-002', 'q5555555-5555-5555-5555-555555555555', 'mcq',
...
('qe555-003', 'q5555555-5555-5555-5555-555555555555', 'true_false',
...
('qe555-004', 'q5555555-5555-5555-5555-555555555555', 'mcq',
...
('qe555-005', 'q5555555-5555-5555-5555-555555555555', 'mcq',
...
('qe555-006', 'q5555555-5555-5555-5555-555555555555', 'mcq',
...
('qe555-007', 'q5555555-5555-5555-5555-555555555555', 'true_false',
...
('qe555-008', 'q5555555-5555-5555-5555-555555555555', 'mcq',
...
INSERT INTO quiz_questions (id, quiz_id, question_type, question, options, points, order_index, explanation, created_at) VALUES
('qe777-001', 'q7777777-7777-7777-7777-777777777777', 'mcq',
...
('qe777-002', 'q7777777-7777-7777-7777-777777777777', 'mcq',
...
('qe777-003', 'q7777777-7777-7777-7777-777777777777', 'true_false',
...
('qe777-004', 'q7777777-7777-7777-7777-777777777777', 'mcq',
...
('qe777-005', 'q7777777-7777-7777-7777-777777777777', 'mcq',
...
('qe777-006', 'q7777777-7777-7777-7777-777777777777', 'mcq',
...
INSERT INTO quiz_questions (id, quiz_id, question_type, question, options, points, order_index, explanation, created_at) VALUES
('qe999-001', 'q9999999-9999-9999-9999-999999999999', 'mcq',
...
('qe999-002', 'q9999999-9999-9999-9999-999999999999', 'mcq',
...
('qe999-003', 'q9999999-9999-9999-9999-999999999999', 'mcq',
...
('qe999-004', 'q9999999-9999-9999-9999-999999999999', 'true_false',
...
('qe999-005', 'q9999999-9999-9999-9999-999999999999', 'mcq',
...
('qe999-006', 'q9999999-9999-9999-9999-999999999999', 'mcq',
...
('qe999-007', 'q9999999-9999-9999-9999-999999999999', 'mcq',
...
('qe999-008', 'q9999999-9999-9999-9999-999999999999', 'true_false',
...
VALUES (
  'assign-0001-0001-0001-000000000001',
...
INSERT INTO assignments (id, lesson_id, title, instructions, due_date, max_score, allowed_file_types, created_at)
VALUES (
  'assign-0002-0002-0002-000000000002',
...
INSERT INTO assignments (id, lesson_id, title, instructions, due_date, max_score, allowed_file_types, created_at)
VALUES (
  'assign-0003-0003-0003-000000000003',
  'aaaaaaaa-000a-000a-000a-000000000005',
...
VALUES (
  'res-0001-0001-0001-000000000001',
  '22222222-0002-0002-0002-000000000006',
...
INSERT INTO resources (id, lesson_id, title, file_url, file_type, file_size, download_count, created_at)
VALUES (
  'res-0002-0002-0002-000000000002',
  '33333333-0003-0003-0003-000000000006',
...
INSERT INTO resources (id, lesson_id, title, file_url, file_type, file_size, download_count, created_at)
VALUES (
  'res-0003-0003-0003-000000000003',
...
INSERT INTO resources (id, lesson_id, title, file_url, file_type, file_size, download_count, created_at)
VALUES (
  'res-0004-0004-0004-000000000004',
...
INSERT INTO resources (id, lesson_id, title, file_url, file_type, file_size, download_count, created_at)
VALUES (
  'res-0005-0005-0005-000000000005',
  'aaaaaaaa-000a-000a-000a-000000000002',
